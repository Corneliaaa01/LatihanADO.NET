...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try
            {
                string dbName = @"C:\Users\HP\Documents\MATKUL SEMS 3\Pemrograman Lanjut\Pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                ...
                MessageBox.Show("Data mahasiswa gagal disimpan !!!", "Informasi",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
        ...
        private void btnCariDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Data mahasiswa tidak ditemukkan !", "Informasi", MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                txtNamaDelete.Clear();
